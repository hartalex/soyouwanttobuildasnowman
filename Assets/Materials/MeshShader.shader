    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 node_9452 = ((((i.vertexColor.b*-1.0+1.0)*(i.vertexColor.r*-1.0+1.0))*(i.vertexColor.g*-1.0+1.0))*_rockheight_var.rgb);
                float4 _snowheight_var = tex2D(_snowheight,TRANSFORM_TEX(i.uv0, _snowheight));
                float3 node_2741 = (_snowheight_var.rgb*i.vertexColor.g);
                float3 node_5941 = step(node_9452,node_2741);
                float3 node_5412 = (node_9452+node_2741);
                float3 node_2445 = (_iceheight.rgb*i.vertexColor.b);
                float3 node_9740 = step(node_5412,node_2445);
                ...
                float3 node_4463 = step((node_5412+node_2445),(_pathheight_var.rgb*i.vertexColor.r));
...
/////// Diffuse:
                ...
                float3 node_7413 = lerp(lerp(lerp(_rockalbedo_var.rgb,_snowalbedo_var.rgb,node_5941),_icealbedo_var.rgb,node_9740),_pathalbedo_var.rgb,node_4463);
                float3 diffuseColor = node_7413;
